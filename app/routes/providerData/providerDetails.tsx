        ...
        >
            ...
            >
                <Box>
                    ...
                    <Typography variant='body1' color={theme.palette.cusp_iron.contrastText}>PRV12345</Typography>
                </Box>

                <Stack direction="row" spacing={3}>
                    <Box>
                        <Typography variant='subtitle1' color={theme.palette.cusp_iron.contrastText}>Provider Type</Typography>
                        <Typography variant='body1'>Home Health Agency</Typography>
                    </Box>
                     <Box>
                        <Typography variant='subtitle1' color={theme.palette.cusp_iron.contrastText}>Phone</Typography>
                        <Typography variant='body1'>(555) 123-4567</Typography>
                    </Box>
                     <Box>
                        <Typography variant='subtitle1' color={theme.palette.cusp_iron.contrastText}>Last Audited</Typography>
                        <Typography variant='body1'>2023-10-15</Typography>
                    </Box>
                </Stack>

                <Box>
                    <Typography variant='subtitle1' color={theme.palette.cusp_iron.contrastText}>Address</Typography>
            ...
            >
                <Box display='flex' justifyContent='space-between' alignItems="center">
                    <Box>
                        ...
                        <Typography variant='body1' color={theme.palette.cusp_iron.contrastText}> Record of previous audits and findings</Typography>
                    </Box>
                    <Button
                        onClick={() => {console.log("Pressed Me!")}}
                        sx={{
